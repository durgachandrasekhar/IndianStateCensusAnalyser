...
namespace CensusAnalyserTest
{
    public class Tests
    {
        ...
        //CorrectFilePaths
        static string indianStateCensusFilePath = @"C:\Users\SHIVA KUMAR\source\repos\IndianStateCensus\IndianStateCensus\IndiaStateCensusData.csv";
        static string indianStateCodeFilePath = @"C:\Users\SHIVA KUMAR\source\repos\IndianStateCensus\IndianStateCensus\IndiaStateCode.csv";
        //WrongFilePaths
        static string wrongIndianStateCodeFilePath = "";
        static string wrongIndianStateCensusFilePath = "";
        //WrongFiles
        static string wrongHeaderIndianStateCodeFile = @"C:\Users\SHIVA KUMAR\source\repos\IndianStateCensus\IndianStateCensus\WrongIndiaStateCode.csv";
        static string wrongHeaderIndianStateCensusFile = @"C:\Users\SHIVA KUMAR\source\repos\IndianStateCensus\IndianStateCensus\WrongIndiaStateCensusData.csv";
        static string wrongIndianStateCodeFileType = @"C:\Users\SHIVA KUMAR\source\repos\IndianStateCensus\IndianStateCensus\IndianStateCode.txt";
        static string wrongIndianStateCensusFileType = @"C:\Users\SHIVA KUMAR\source\repos\IndianStateCensus\IndianStateCensus\IndiaStateCensusData.txt";
        //WrongDelimiter
        static string wrongDelimiterIndianCensusFilePath = @"C:\Users\SHIVA KUMAR\source\repos\IndianStateCensus\IndianStateCensus\DelimiterIndiaStateCensusData.csv";
        static string wrongDelimiterIndianStateCodeFilePath = @"C:\Users\SHIVA KUMAR\source\repos\IndianStateCensus\IndianStateCensus\DelimiterIndiaStateCode.csv";
