...
namespace CensusAnalyserTest
{
    public class Tests
    {
        ...
        //CorrectFilePaths
        static string indianStateCensusFilePath = @"C:\Users\SHIVA KUMAR\source\repos\IndianStateCensus\IndianStateCensus\CSVFiles\IndiaStateCensusData.csv";
        static string indianStateCodeFilePath = @"C:\Users\SHIVA KUMAR\source\repos\IndianStateCensus\IndianStateCensus\CSVFiles\IndiaStateCode.csv";
        //WrongFilePaths
        static string wrongIndianStateCodeFilePath = "";
        static string wrongIndianStateCensusFilePath = "";
        //WrongFiles
        static string wrongHeaderIndianStateCodeFile = @"C:\Users\SHIVA KUMAR\source\repos\IndianStateCensus\IndianStateCensus\CSVFiles\WrongIndiaStateCode.csv";
        static string wrongHeaderIndianStateCensusFile = @"C:\Users\SHIVA KUMAR\source\repos\IndianStateCensus\IndianStateCensus\CSVFiles\WrongIndiaStateCensusData.csv";
        static string wrongIndianStateCodeFileType = @"C:\Users\SHIVA KUMAR\source\repos\IndianStateCensus\IndianStateCensus\CSVFiles\IndianStateCode.txt";
        static string wrongIndianStateCensusFileType = @"C:\Users\SHIVA KUMAR\source\repos\IndianStateCensus\IndianStateCensus\CSVFiles\IndianStateCensusData.txt";
        //WrongDelimiter
        static string wrongDelimiterIndianCensusFilePath = @"C:\Users\SHIVA KUMAR\source\repos\IndianStateCensus\IndianStateCensus\CSVFiles\DelimiterIndiaStateCensusData.csv";
        static string wrongDelimiterIndianStateCodeFilePath = @"C:\Users\SHIVA KUMAR\source\repos\IndianStateCensus\IndianStateCensus\CSVFiles\DelimiterIndiaStateCode.csv";
